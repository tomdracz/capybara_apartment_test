...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{ User Site SiteUser }
  ...
  #
  config.tenant_names = lambda { Site.pluck(:name).map { |s| s.parameterize(separator: "_") } }
...
require_relative '../../lib/middleware/test_elevator.rb'
